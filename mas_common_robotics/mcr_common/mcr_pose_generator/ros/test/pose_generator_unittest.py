#!/usr/bin/env python
"""
Test unit for the functions/methods used in the pose_generator.py module.
...
import unittest
import rosunit
import mcr_pose_generator_ros.pose_generator as pose_generator
...
class TestPoseGenerator(unittest.TestCase):
    ...
    def test_generate_samples_basic(self):
        ...
        actual_result = pose_generator.generate_samples(min_value, max_value, step)
    ...
    def test_generate_samples_max_samples_exceeded(self):
        ...
        result = pose_generator.generate_samples(
